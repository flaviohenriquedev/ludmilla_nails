...
export default function RootLayout({
    ...
    return (
        ...
        <header
            className={`flex w-full text-sm items-center justify-center gap-10 max-h-10 min-h-10 bg-primary text-primary-content px-80`}>
            <span>(62) 9 9102-1871</span>
            <span>ludmillafernandagomes@gmail.com</span>
        </header>

        <div className={`flex w-full p-5 items-start justify-between max-h-36 min-h-36 bg-base-300 px-80`}>
            <Logo/>
            <ul className={`flex gap-2 text-base-content`}>
                {renderMenuNavegacao()}
            </ul>
        </div>
        {children}
