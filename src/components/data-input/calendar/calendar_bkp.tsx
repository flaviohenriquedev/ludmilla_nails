...
export function CalendarBKP() {
    ...
    function renderDiasSemana() {
        return diasSemana.map(diasSemana => {
            return (
                <div key={diasSemana.descricao} className="flex justify-center bg-white py-2">
                    <span>{diasSemana.descricao}</span>
                </div>
            )
        })
    }
    ...
    return (
        <div className="lg:flex lg:h-full lg:flex-col">
            <header
                className="flex items-center justify-between border-b border-gray-200 px-6 py-4 lg:flex-none bg-red-300">
                ...
                <div className="flex items-center bg-blue-300">
                    <div className="bg-violet-300 relative flex items-center rounded-md shadow-sm md:items-stretch">
                        <button type="button"
                        ...
                        <button type="button"
                                className="hidden border-y border-gray-300 px-3.5 text-sm font-semibold text-gray-900 hover:bg-gray-50 focus:relative md:block">Hoje
                        </button>
